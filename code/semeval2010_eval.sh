...
do
    ...
    for i in {0..9}
    do
        fscore=$(java -jar ../semeval-2010-task-14/evaluation/unsup_eval/fscore.jar ../logs/semeval2010/semeval2010_clusters${j}_${i} ../semeval-2010-task-14/evaluation/unsup_eval/keys/all.key all | tail -1)

        vmeasure=$(java -jar ../semeval-2010-task-14/evaluation/unsup_eval/vmeasure.jar ../logs/semeval2010/semeval2010_clusters${j}_${i} ../semeval-2010-task-14/evaluation/unsup_eval/keys/all.key all | tail -1)
